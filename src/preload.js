...
contextBridge.exposeInMainWorld('petAPI', {
  ...
  onTyping: callback => ipcRenderer.on('typing-pulse', (_event, value) => callback(value)),
  onReminder: callback => ipcRenderer.on('wellness-reminder', (_event, value) => callback(value)),
